/**
 * DOMBuilder 2.1-alpha (modes: dom [default], html, template) - https://github.com/insin/DOMBuilder
 * MIT licensed
 */
(function(__global__) {
...
function ElementNode(tagName, attributes, contents) {
  ...
  for (var name in this.attributes) {
    ...
    } else if ((attr instanceof TemplateNode || attr instanceof Variable) && !this.dynamicAttrs) {
      this.dynamicAttrs = true;
    }
  }
  TemplateNode.call(this, contents);
